...
window.healthRecordData = [
  {
    ...
    advice: {
      ...
      points: [
        ...
        { label: "유리당", text: "현재 약 55~85g으로 추정돼 2,000kcal 기준 WHO 권고 상한 50g을 넘었을 가능성이 높고, 추가 이점 기준 25g보다는 확실히 높다. 야채농장 2팩의 당류 약 32g과 사탕·비스킷·약과가 주된 원인이다. 하루 한 번만으로 문제를 단정하지 말고 앞으로의 평균과 빈도를 줄이는 쪽으로 본다." },
