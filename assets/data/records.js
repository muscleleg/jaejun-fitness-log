...
window.healthRecordData = [
  {
    ...
    nutritionEstimate: {
      ...
      freeSugar: "현재 약 55~85g · 치킨팝 닭강정맛 섭취 시 약 73~103g",
      nutrients: {
        ...
        freeSugar: { min: 55, max: 85, unit: "g" },
        fiber: { min: 6, max: 14, unit: "g" },
        sodium: { min: 2200, max: 4500, unit: "mg" }
      },
      assumptions: "기존 기록에 저녁과 추가 간식을 합산했다. 흰밥은 보통 한 공기, 소고기 볶음은 약 120~180g, 연두부는 간장 소스를 포함한 보통 1회분으로 가정했다. 더단백 초코는 250ml 105kcal·단백질 20g, 야채농장은 오늘 총 2팩으로 170kcal·단백질 4g·당류 약 32g을 반영했다. 로투스는 오늘 총 2조각, 레몬 사탕은 총 2개, 망고 크림크래커는 1개 약 40~45kcal·단백질 1g 미만으로 추정했다. 유리당은 주스·사탕·과자·약과와 볶음 양념에 든 당을 합쳐 범위로 추정했다. 치킨팝은 아직 먹지 않은 65g 한 봉지로 보고 현재 합계에서 제외했으며, 맛이 확인되지 않아 열량 예상에는 공식 제품별 약 333~338kcal와 단백질 약 2g을 더했다. 유리당 예상은 닭강정맛의 당류 18g을 기준으로 했다. 오쏘몰은 제품 종류에 따라 열량과 당류 차이가 있어 넓은 범위로 반영했다.",
    ...
    advice: {
      ...
      points: [
        ...
        { label: "유리당", text: "현재 약 55~85g으로 추정된다. 남성 30~49세 참고 에너지 2,500kcal에 적용한 WHO 상한 약 63g의 87~135%이며, 추가 이점 기준 약 31g은 확실히 넘는다. 야채농장 2팩의 당류 약 32g과 사탕·비스킷·약과가 주된 원인이다." },
